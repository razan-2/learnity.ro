...
const RedirectButton2 = ({ text }) => {
  return (
    <button className="relative inline-block w-32 h-10 leading-10 m-5 cursor-pointer overflow-hidden border-2 border-customBlue text-customBlue transition-colors duration-500 rounded-md font-medium text-lg z-0">
      { text }
