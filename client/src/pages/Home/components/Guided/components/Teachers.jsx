...
const teachers = [
  { 
    ...
    subject: 'Povești despre Antreprenoriat', 
  ...
  { 
    ...
    subject: 'Psihologie Aplicată', 
    course: 'Rise and Fall of Ancient Civilizations',
    years: '2019-2021',
    photo: '/placeholder.svg?height=200&width=200'
  },
  { 
    name: 'Andrei Stupu', 
    subject: 'Effective Comunication', 
    course: 'Crafting Compelling Characters',
    years: '2020-2022',
    photo: '/placeholder.svg?height=200&width=200'
  },
  { 
    name: 'Ana Coman', 
    subject: 'Debate', 
    course: 'Climate Change and Sustainability',
    years: '2017-2019',
    photo: '/placeholder.svg?height=200&width=200'
  },
]

const TeacherCard = ({ name, subject, course, years, photo }) => (
  <motion.div
  ...
  >
    ...
    <h3 className="text-[#2f2f27] text-xl font-bold mb-2 text-center">{name}</h3>
    <p className="text-[#2f2f27] mb-1 text-center">{subject}</p>
    <p className="text-[#2f2f27] text-sm mb-2 text-center italic">"{course}"</p>
